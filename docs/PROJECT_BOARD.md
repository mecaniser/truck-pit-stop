...
|---|---|---|---|---|---|---|
| DB-003 | P1 | Review — reconciled with released DB-035 | Finish versioned additional-work authorizations without regressing the authenticated garage cockpit | Backend & Integrations | Authoritative DB-003 candidate `2451f740ccb2e9bb5c0d5b94e56f2bde0ec6a5fe` is rebased onto `origin/main` `79ee5d39eaeb67f6631308b5f58700ebfcd3a9b6` in isolated branch `codex/db003-db035-reconciliation`. DB-035 workstation structure/tests and DB-003 authorization behavior are both preserved. The migration graph is linear: released `118_authenticated_presentation` → `119_ro_projection_cardinality`. Evidence: frontend focused `72/72`; backend boundary/security `226/226`; fresh PG15 empty `0→119`, PG race/principal/role `14/14`, populated `119→118→119` with projection cardinality `1`; full frontend `293/293`; production build PASS; full pinned backend `845 passed/17 skipped`; strict DB-003/customer-portal Playwright `11/11` with clean fail-closed runtime fixtures. No production migration, push, PR, merge, or deploy occurred. | Product assigns fresh independent Security and QA on the exact post-handoff SHA. Any P0–P2 returns to implementation; after dual GO, push one focused PR, require protected CI, then request explicit merge/deploy authority. |
