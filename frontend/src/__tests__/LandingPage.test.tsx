...
describe('LandingPage shop workflow', () => {
  ...
  it('presents the shop-first workflow and concise approved-shop proof', async () => {
    ...
    expect(headerBrand.querySelector('.db-wordmark--animated')).toBeInTheDocument()
    expect(headerBrand.querySelector('.db-wordmark__name')).toBeInTheDocument()
    expect(headerBrand.querySelector('.db-wordmark__letters')).toHaveTextContent('DieselBridge')
    expect(headerBrand.querySelectorAll('.db-wordmark__letter')).toHaveLength(12)
    expect(headerBrand.querySelectorAll('.db-wordmark__letter--bridge')).toHaveLength(6)
    expect(headerBrand.querySelectorAll('.db-wordmark__bridge-base')).toHaveLength(1)
    expect(headerBrand.querySelectorAll('.db-wordmark__bridge-pillars')).toHaveLength(1)
    expect(headerBrand.querySelectorAll('.db-wordmark__bridge-arch')).toHaveLength(1)
    const animatedLetters = [...headerBrand.querySelectorAll<HTMLElement>('.db-wordmark__letter')]
    ...
    expect(document.querySelectorAll('.db-wordmark--animated')).toHaveLength(1)
    expect(document.querySelector('.landing-footer .db-wordmark')).not.toHaveClass('db-wordmark--animated')
