...
type ViewType = 'list' | 'detail' | 'history' | 'stats'
      ...
      <Container>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-gradient-to-br from-amber-500 to-orange-600 rounded-2xl p-6 text-center">
            ...
            <p className="text-5xl font-black text-white">{stats?.total_points || 0}</p>
          </div>
          ...
          <div className="bg-gray-800 rounded-2xl p-4 border border-gray-700">
            ...
            <div className="space-y-3">
              {[
                { pts: 100, label: 'Rookie', icon: '🔧' },
                { pts: 500, label: 'Pro', icon: '⭐' },
                { pts: 1000, label: 'Expert', icon: '🏆' },
                { pts: 5000, label: 'Master', icon: '👑' },
              ].map((m) => {
                ...
                return (
                  <div key={m.pts} className={`flex items-center gap-3 ${achieved ? '' : 'opacity-40'}`}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-gray-500">{m.pts} points</p>
                    </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              ...
              <span className="text-amber-400 font-bold">{stats?.total_points || 0}</span>
            </button>
            <button
