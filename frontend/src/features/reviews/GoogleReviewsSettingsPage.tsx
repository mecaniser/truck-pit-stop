...
export default function GoogleReviewsSettingsPage() {
  ...
  const { data: locations = [], isLoading: locationsLoading } = useQuery<Location[]>({ queryKey: ['google-review-locations'], queryFn: async () => (await api.get('/google-reviews/connection/locations')).data, enabled: selectionPending })
